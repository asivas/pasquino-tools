...
class Proyecto extends Entidad {
	...
	function getTieneProyectoEclipse() {
		return $this->tieneProyectoEclipse;
	}

	function setTieneProyectoEcplipse($tiene) {
		$this->tieneProyectoEclipse = $tiene;
	}
